...
class Mailer
{
    ...
    {
        $url = $this->router->generate('user_activate', ['token' => $user->getToken(), 'email'=> $user->getEmail()], UrlGeneratorInterface::ABSOLUTE_URL);
    ...
    {
        $url = $this->router->generate('user_reset_password', ['token' => $user->getToken(), 'email'=> $user->getEmail()], UrlGeneratorInterface::ABSOLUTE_URL);
